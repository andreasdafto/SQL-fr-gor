-- Shows only campaign rows where TotalPrice is positive.
-- These are suspicious because a campaign row should normally reduce the booking.

DECLARE @CampaignCode nvarchar(100);
SET @CampaignCode = NULL;
-- Example:
-- SET @CampaignCode = N'BLACK30';
